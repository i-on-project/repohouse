...
val GITHUB_OAUTH_URI: (scope: String, state: String, redirectUri: String?) -> String = { scope, state, redirectUri ->
...
val MOBILE_GITHUB_OAUTH_URI: (scope: String, state: String, redirectUri: String?) -> String = { scope, state, redirectUri ->
    "/login/oauth/authorize?" +
