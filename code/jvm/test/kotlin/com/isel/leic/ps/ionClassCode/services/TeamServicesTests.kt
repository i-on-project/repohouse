            ...
            override fun <R> run(block: (Transaction) -> R): R {
                val mockedTransaction = mock<Transaction> {
                    ...
                    val mockedCreateTeamRepository = mock<CreateTeamRepository> {
                        on { createCreateTeamRequest(request = CreateTeamInput(teamId = 1, composite = 1), creator = 1) } doReturn CreateTeam(id = 1, creator = 1, composite = 1, teamId = 1, githubTeamId = 1)
                        on { createCreateTeamRequest(request = CreateTeamInput(teamId = 2, composite = 2), creator = 2) } doReturn CreateTeam(id = 2, creator = 2, composite = 2, teamId = 2, githubTeamId = 2)
                    }
