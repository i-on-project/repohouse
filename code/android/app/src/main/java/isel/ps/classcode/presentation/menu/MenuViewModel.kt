...
class MenuViewModel(private val menuServices: MenuServices, private val gitHubFunctions: GitHubFunctions) : ViewModel() {
    ...
    fun getUserInfo() = viewModelScope.launch {
        when (val userInfo = gitHubFunctions.getUserInfo()) {
