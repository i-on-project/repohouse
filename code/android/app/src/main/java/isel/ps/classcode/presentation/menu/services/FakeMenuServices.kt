...
class FakeMenuServices : MenuServices {
    ...
    override suspend fun getCourses(): Either<HandleClassCodeResponseError, Unit> {
        return Either.Right(Unit)//Either.Right(value = listOf(Course(id = 1, name = "PDM", imageUrl = "https://avatars.githubusercontent.com/u/6817318?s=200&v=4"), Course(id = 2, name = "LAE", imageUrl = "https://avatars.githubusercontent.com/u/5501606?s=200&v=4"), Course(id = 3, name = "DAW", imageUrl = "https://avatars.githubusercontent.com/u/10852760?s=200&v=4")))
    }
